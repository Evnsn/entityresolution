...
"""
    ...
    - Make progressbar optional. Why:
        - Incase of implementation besides notebooks 
        - Optional to install `tdqm` and  `ipywidgets`
    - Add progress bar to `download_and_extract_tar`
    - Make displaing progressbar optional
"""
